...
import de.goll.components.appnav.AppNav;
import de.goll.components.appnav.AppNavItem;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("gutachten-webproject");
    ...
    private AppNav createNavigation() {
        ...
        if (accessChecker.hasAccess(AuftragsübersichtView.class)) {
